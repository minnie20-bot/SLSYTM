                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('panel/school_admin/delete/'.$value->id) }}" onclick="return confirm('Are ou sure you want to delete?');" class="btn btn-danger btn-rounded btn-sm"><span class="fa fa-times"></span></a>
                                    </td>
                                </tr>
                                @empty
                                    <tr>
